...
import {NCard, NSpace, NP, NH3, NImage, NTag, NIcon, NDivider} from "naive-ui";
...
<template>
    <n-card>
        <div class="flex">
            ...
            <n-space vertical class="course-info h-full w-full pl-10">
                <n-h3>
                    {{ props.course.name }}
                </n-h3>
                <n-space>
                ...
                <n-tag type="success" round :bordered="false" class="mt-2">
                    ...
                    <template #icon>
                        <n-icon :component="People" class="mr-1">
                        </n-icon>
                    </template>
                </n-tag>
                <n-divider>
